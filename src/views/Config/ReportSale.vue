...
export default {
  ...
  methods: {
    ...
    printDate() {
      ...
      axios
        .post("/auth/sales/printADate",{date:me.date,id_storage:me.id_storage})
     ...
     printDateToDate() {
      ...
      axios
        .post("/auth/sales/printDateToDate",{date:[me.date_start,me.date_end],id_storage:me.id_storage})
        .then(function (response) {
          console.log(response)
          let url = response.data.data;
          window.open(url);
     ...
     printMonth() {
      ...
      axios
        .post("/auth/sales/printForMonth",{date:me.month,id_storage:me.id_storage})
        .then(function (response) {
          console.log(response)
          let url = response.data.data;
          window.open(url);
      ...
      axios
        .post("/auth/sales/exportADate",{date:me.date,id_storage:me.id_storage})
        .then(function (response) {
          console.log(response);
          let url = response.data.data;
          window.open(url);
     ...
     excelDateToDate() {
      ...
      axios
        .post("/auth/sales/exportDateToDate",{date:[me.date_start,me.date_end],id_storage:me.id_storage})
        .then(function (response) {
          console.log(response)
          let url = response.data.data;
          window.open(url);
     ...
     excelMonth() {
      ...
      axios
        .post("/auth/sales/exportForMonth",{date:me.month,id_storage:me.id_storage})
        .then(function (response) {
          console.log(response)
          let url = response.data.data;
          window.open(url);
